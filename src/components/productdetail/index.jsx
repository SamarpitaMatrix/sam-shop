...
const AddProductDetail =() => {
    ...
    useEffect(() => {
        ...
        let url='https://yourcloudnetwork.net/projects/training/wp-json/wc/v3/products/'+id+'/?consumer_key='+consumer_key+'&consumer_secret='+consumer_secret;
        axios({
            method: 'get',
    ...
    <div className="container-fluid py-5">
        <div className="row px-xl-5">
            ...
            <div className="col-lg-7 pb-5">
                ...
                <h3 className="font-weight-semi-bold mb-4"><div
